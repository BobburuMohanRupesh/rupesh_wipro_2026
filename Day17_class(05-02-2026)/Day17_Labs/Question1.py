...
# 1 Registration Form – Text boxes, Radio, Checkbox

driver.get("https://tutorialsninja.com/demo/index.php?route=account/register")
time.sleep(3)

# 1. Fill text boxes
driver.find_element(By.ID, "input-firstname").send_keys("abhi")
driver.find_element(By.ID, "input-lastname").send_keys("ram")
driver.find_element(By.ID, "input-email").send_keys(email)
driver.find_element(By.ID, "input-telephone").send_keys("9876543210")
driver.find_element(By.ID, "input-password").send_keys("abhi@123")
driver.find_element(By.ID, "input-confirm").send_keys("abhi@123")
...
# 3️  Drop-down handling using Select class
